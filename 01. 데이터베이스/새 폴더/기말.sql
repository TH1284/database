create table PRO_FCST_RESULT_1WEEK_TT as
select PRD_SEG1, PRD_SEG2, PRD_SEG3, '201918' as PLANWEEK, CONCAT(YEAR,WEEK) as TARGETWEEK , YEAR, WEEK, QTY, OUTFCST
from PRO_FCST_RESULT_1WEEK
WHERE CONCAT(YEAR,WEEK) = '201918'
ORDER BY PRD_SEG1, PRD_SEG2, PRD_SEG3

create table PRO_FCST_RESULT_2WEEK_TT as
select PRD_SEG1, PRD_SEG2, PRD_SEG3, '201917' as PLANWEEK, CONCAT(YEAR,WEEK) as TARGETWEEK , YEAR, WEEK, QTY, OUTFCST
from PRO_FCST_RESULT_2WEEK
WHERE CONCAT(YEAR,WEEK) = '201918'
ORDER BY PRD_SEG1, PRD_SEG2, PRD_SEG3

SELECT * FROM PRO_FCST_RESULT_2WEEK_TT

drop table PRO_FCST_RESULT_2WEEK_TT

create table PRO_FCST_RESULT_3WEEK_TT as
select PRD_SEG1, PRD_SEG2, PRD_SEG3, '201916' as PLANWEEK, CONCAT(YEAR,WEEK) as TARGETWEEK , YEAR, WEEK, QTY, OUTFCST
from PRO_FCST_RESULT_3WEEK
WHERE CONCAT(YEAR,WEEK) = '201918'
ORDER BY PRD_SEG1, PRD_SEG2, PRD_SEG3

SELECT * FROM PRO_FCST_RESULT_6WEEK_TT

drop table PRO_FCST_RESULT_3WEEK_TT

create table PRO_FCST_RESULT_4WEEK_TT as
select PRD_SEG1, PRD_SEG2, PRD_SEG3, '201915' as PLANWEEK, CONCAT(YEAR,WEEK) as TARGETWEEK, YEAR, WEEK, QTY, OUTFCST
from PRO_FCST_RESULT_4WEEK
WHERE CONCAT(YEAR,WEEK) = '201918'
ORDER BY PRD_SEG1, PRD_SEG2, PRD_SEG3

create table PRO_FCST_RESULT_5WEEK_TT as
select PRD_SEG1, PRD_SEG2, PRD_SEG3, '201914' as PLANWEEK, CONCAT(YEAR,WEEK) as TARGETWEEK, YEAR, WEEK, QTY, OUTFCST
from PRO_FCST_RESULT_5WEEK
WHERE CONCAT(YEAR,WEEK) = '201918'
ORDER BY PRD_SEG1, PRD_SEG2, PRD_SEG3


create table PRO_FCST_RESULT_6WEEK_TT as
select PRD_SEG1, PRD_SEG2, PRD_SEG3, '201913' as PLANWEEK, CONCAT(YEAR,WEEK) as TARGETWEEK, YEAR, WEEK, QTY, OUTFCST
...
SELECT A.PRD_SEG1, A.PRD_SEG2, A.PRD_SEG3, A.YEAR, A.WEEK, A.QTY AS ACTUAL, F.OUTFCST AS W6, E.OUTFCST AS W5, D.OUTFCST AS W4, C.OUTFCST AS W3, B.OUTFCST AS W2, A.OUTFCST AS W1, 
        ...
        (NVL(F.OUTFCST,0)*CASE WHEN NVL(F.OUTFCST,0) = 0 OR A.QTY = 0 THEN 0
             WHEN (A.QTY/F.OUTFCST) > 2 THEN 0
             ELSE 1-(NVL(ABS(F.OUTFCST-A.QTY), A.QTY)/F.OUTFCST) END AS ACC8W_W6) AS ACC8W_QTY_W6
...
(NVL2(F.OUTFCST,1,0)+ NVL2(E.OUTFCST,1,0)+ NVL2(D.OUTFCST,1,0)+ NVL2(C.OUTFCST,1,0)+ NVL2(B.OUTFCST,1,0)+ NVL2(A.OUTFCST,1,0))



SELECT * FROM TH

SELECT PRD_SEG1, sum(FCST_AVG), sum(ACC_AVG), (sum(ACC_AVG)/ sum(FCST_AVG)) AS ACCURACY FROM TH
GROUP BY PRD_SEG1--,((ACC_AVG/FCST_AVG))
ORDER BY PRD_SEG1



CREATE TABLE THTHTH2 (
PRD_SEG1    VARCHAR2(20),
PRD_SEG2    VARCHAR2(20),
PRD_SEG3    VARCHAR2(20),
YEAR        VARCHAR2(20),
WEEK        VARCHAR2(20),
ACTUAL      VARCHAR2(20),
W6          VARCHAR2(20),
...
W2          VARCHAR2(20),
W1          VARCHAR2(20),
ABS8W_W6    VARCHAR2(20),
ABS8W_W5    VARCHAR2(20),
ABS8W_W4    VARCHAR2(20),
ABS8W_W3    VARCHAR2(20),
ABS8W_W2    VARCHAR2(20),
ABS8W_W1    VARCHAR2(20),
ACC8W_W6    VARCHAR2(20),
ACC8W_W5    VARCHAR2(20),
ACC8W_W4    VARCHAR2(20),
ACC8W_W3    VARCHAR2(20),
ACC8W_W2    VARCHAR2(20),
ACC8W_W1    VARCHAR2(20),
ACC8W_QTY_W6    VARCHAR2(20),
ACC8W_QTY_W5    VARCHAR2(20),
ACC8W_QTY_W4    VARCHAR2(20),
ACC8W_QTY_W3    VARCHAR2(20),
ACC8W_QTY_W2    VARCHAR2(20),
ACC8W_QTY_W1    VARCHAR2(20),
FCST_AVG    VARCHAR2(20),
ACC_AVG     VARCHAR2(20)
)
...
SELECT A.*, B.*
FROM TH A
FULL OUTER JOIN THTHTH2 B
ON 1=1
AND A.ACC_AVG = B.ACC_AVG

SELECT * FROM TH
WHERE ACC_AVG not in (select ACC_AVG from THTHTH2)